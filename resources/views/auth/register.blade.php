                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label for="role" class="col-md-4 col-form-label text-md-end font-weight-bold">{{ __('Role') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end font-weight-bold">{{ __('Confirm Password') }}</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4 text-center">
                                ...
                                <p class="mt-3">Already Register?</p>
